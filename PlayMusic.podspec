#
#  Be sure to run `pod spec lint PlayMusic.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/shibatatsuya0611/PlayMusic"
  ...
  spec.source       = { :git => "https://github.com/shibatatsuya0611/PlayMusic.git", :tag => "#{spec.version}" }
